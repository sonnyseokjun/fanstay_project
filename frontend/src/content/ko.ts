...
export const ko: Content = {
  ...
  problems: {
    title: '지금 한 달 살기는\n개인의 정보력으로 버팁니다',
    intro: '해외 한 달 살기 수요는 커졌지만 준비 방법은 10년 전과 같습니다. 블로그와 카페, 단톡방을 뒤지고, 검증되지 않은 개인 거래로 목돈을 보냅니다.',
    items: [
      {
        topic: '숙소',
        title: '월 단위 숙소를 찾을 곳이 없어요',
        body: '국내 한 달 살기 플랫폼은 제주·강릉 같은 국내 매물 위주이고, 해외 숙소 앱은 1박 가격 기준이라 한 달을 묵으면 비쌉니다. 결국 현지 부동산과 페이스북 그룹, 한인 카페를 직접 뒤지게 됩니다.',
  ...
  solution: {
    ...
    matrix: {
      caption: '한국인이 해외에서 월 단위로 머물 때 쓸 수 있는 서비스 비교',
      conditions: ['한국인을 위한 서비스', '해외 숙소', '월 단위 계약'],
      yes: '해당',
      no: '해당 없음',
      rows: [
  ...
  features: {
    ...
    cities: {
      title: '처음 문을 여는 도시',
      intro: '한국인의 장기 체류 수요가 이미 확인된 네 도시부터 매물과 후기, 커뮤니티를 촘촘하게 채웁니다.',
      list: [
        { name: '치앙마이', country: '태국', note: '카페와 코워킹이 많은 북부 도시' },
        { name: '다낭', country: '베트남', note: '바다와 도심이 가까운 해변 도시' },
        { name: '발리', country: '인도네시아', note: '요가·서핑과 자연 속 생활' },
  ...
  flow: {
    ...
    steps: [
      ...
      { when: '출발 1주 전', title: '출국 준비', body: '비자·보험·유심 체크리스트가 내 일정에 맞춰 만들어져요.' },
  ...
  pricing: {
    title: '한 달, 얼마면 될까요',
    intro: '네 도시에서 한 달을 보낼 때 드는 비용을 공개된 후기와 가이드로 추정했습니다.',
  ...
  faq: {
    ...
    items: [
      {
        q: '팬스테이는 언제 열리나요?',
        a: '치앙마이부터 도시별로 차례대로 엽니다. 날짜가 정해지면 사전가입한 분께 이메일로 가장 먼저 알려 드립니다.',
      },
      {
        q: '사전가입하면 돈을 내야 하나요?',
      ...
      {
        q: '다른 도시는 언제 추가되나요?',
        a: '치앙마이·다낭·발리·후쿠오카 네 도시부터 시작합니다. 다음 도시는 사전가입 설문에서 많이 고른 나라를 먼저 검토합니다.',
      },
      {
        q: '가격 예시는 실제 가격인가요?',
  ...
  thanks: {
    ...
    shareText: '해외 한 달 살기, 숙소부터 현지 생활까지 한 번에. 팬스테이 사전가입',
    copied: '링크를 복사했어요',
