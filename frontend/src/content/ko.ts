...
const ko: Content = {
  meta: {
    title: 'HANSTAY｜서울 한 달 살기 리빙팩 사전가입',
    description: '방은 예약할 수 있지만 한국에서의 생활은 예약할 수 없습니다. HANSTAY는 서울에서의 30일을 하나의 상품으로 만듭니다. 지금 사전가입을 받고 있습니다.',
    htmlLang: 'ko',
  },
  header: { cta: '사전가입', switchTo: 'zh', switchLabel: '中文', home: 'HANSTAY 홈', skipToForm: '사전가입 양식으로 건너뛰기' },

  hero: {
    headline: ['방은 예약할 수 있지만', '한국에서의 생활은', '예약할 수 없습니다.'],
    body: 'HANSTAY는 숙소를 중심으로 서울에서의 30일을 하나의 상품으로 만듭니다. 보증금 없는 풀옵션 집, 걸어서 15분 안의 생활 편의, 살아봐야 알 수 있는 한국식 라이프스타일까지 함께 담았습니다.',
    cta: '사전가입하기',
  ...
  signup: {
    ...
    consent: {
      label: 'HANSTAY가 위 정보를 수집하고 이용하는 데 동의합니다',
      notice:
  ...
  thanks: {
    ...
    body: 'HANSTAY가 오픈하면 남겨주신 연락처로 가장 먼저 알려드립니다.',
    shareTitle: '서울 한 달 살기, 같이 갈 친구가 있나요?',
    shareButton: '친구에게 공유하기',
    shareText: '방은 예약할 수 있지만 한국에서의 생활은 예약할 수 없습니다. HANSTAY에서 서울 한 달 살기 사전가입을 받고 있어요:',
  ...
  faq: {
    ...
    items: [
      ...
      { q: '얼마나 머물 수 있나요?', a: 'HANSTAY는 2주에서 3개월의 중장기 체류를 위한 서비스이며, 리빙팩은 30일 단위로 구성합니다.' },
      {
      ...
      },
      {
        ...
        a: 'HANSTAY는 한국에 중단기로 머무는 외국인을 위해 설계했으며, 직접 중개사무소를 통해 계약할 필요가 없습니다. 입주에 필요한 서류는 오픈 시 안내합니다.',
      },
  ...
  footer: {
    ...
    note: '이 페이지는 HANSTAY 오픈 전 사전가입 페이지입니다.',
    copyright: '© 2026 HANSTAY',
  },
}
