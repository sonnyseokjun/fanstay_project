...
const zh: Content = {
  meta: {
    title: 'HANSTAY｜首尔一个月生活包 预注册',
    description: '房间订得到，在韩国的生活却订不到。HANSTAY 把30天的首尔生活打包成一个产品，现在开放预注册。',
    htmlLang: 'zh-CN',
  },
  header: { cta: '预注册', switchTo: 'ko', switchLabel: '한국어', home: 'HANSTAY 首页', skipToForm: '跳到预注册表单' },

  hero: {
    headline: ['房间订得到，', '在韩国的生活', '却订不到。'],
    body: 'HANSTAY 以住处为中心，把30天的首尔生活打包成一个产品：免押金的整套住房、步行15分钟内的生活所需，再加上只有住下来才能体验的韩式生活。',
    cta: '立即预注册',
  ...
  thanks: {
    ...
    body: 'HANSTAY 上线时，我们会通过你留下的联系方式第一时间通知你。',
    shareTitle: '想找人一起来首尔住一个月？',
    shareButton: '分享给朋友',
    shareText: '房间订得到，在韩国的生活却订不到。HANSTAY 把30天的首尔生活打包成一个产品，一起来预注册吧：',
  ...
  faq: {
    ...
    items: [
      ...
      { q: '可以住多久？', a: 'HANSTAY 面向2周到3个月的中长期居住，生活包以30天为基本单位设计。' },
      {
        q: '需要交押金、签复杂的合同吗？',
      ...
      {
        q: '没有外国人登录证也能住吗？',
        a: 'HANSTAY 专为来韩国中短期居住的外国人设计，不需要自己通过中介签租房合同。入住所需的具体材料会在上线时公布。',
      },
